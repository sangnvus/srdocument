...
Ext.onReady(function(){
	...
	onlySearchButtons = YAHOO.util.Dom.getElementsByClassName("openDialogVessel");
	for (i = 0; i < onlySearchButtons.length; i++){
		...
		Sbutton.on('click', function(){
			...
			window.searchFrameVessel.location = framelink;
