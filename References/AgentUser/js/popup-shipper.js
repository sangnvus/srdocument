...
Ext.onReady(function(){
	...
	onlySearchButtons = YAHOO.util.Dom.getElementsByClassName("openDialogShipper");
	for (i = 0; i < onlySearchButtons.length; i++){
		...
		Sbutton.on('click', function(){
			...
			window.searchFrameShipper.location = framelink;
